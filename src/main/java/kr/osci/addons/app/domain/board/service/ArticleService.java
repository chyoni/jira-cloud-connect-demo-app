...
import kr.osci.addons.app.domain.board.client.AtlassianRestClient;
...
public class ArticleService {
    ...
    private final AtlassianRestClient atlassianRestClient;
    ...
    public ArticleCreateResponse create(ArticleCreateRequest request, AtlassianHostUser hostUser) {
        ...
        JiraUserResponse findUser = atlassianRestClient.getJiraUser(hostUser, writerId);
